...
<style>
    ...
    /* Style for Streamlit's chat messages */
    ...
    /* Style specifically for the assistant's messages */
    [data-testid="stChatMessage"][data-testid*="assistant"] {
        background-color: #e8f4f8 !important;
        border-left: 5px solid #1e88e5 !important;
    }
    /* Make the text in assistant messages darker and more visible */
    ...
    /* Make the text in user messages darker */
