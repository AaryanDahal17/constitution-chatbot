...
<style>
    ...
    /* This targets the assistant's message container */
    ...
    /* This specifically targets the assistant's avatar background */
    [data-testid="stChatMessageAvatar"][data-testid*="assistant"] {
        background-color: #2b6cb0 !important;
    }
    /* This specifically targets the assistant's message content */
        ...
        with st.chat_message("assistant"):
            ...
            with st.spinner("Thinking..."):
                ...
                for chunk in answer.split():
                    full_response += chunk + " "
                    time.sleep(0.01)
                    message_placeholder.markdown(f'<div style="background-color: #2b6cb0; color: #ffffff; padding: 10px; border-radius: 8px; border-left: 5px solid #1a365d;">{full_response}▌</div>', unsafe_allow_html=True)
                
                message_placeholder.markdown(f'<div style="background-color: #2b6cb0; color: #ffffff; padding: 10px; border-radius: 8px; border-left: 5px solid #1a365d;">{answer}</div>', unsafe_allow_html=True)
